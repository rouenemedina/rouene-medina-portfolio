    ...
    <main className="socials">
      ...
      <section className="socials__container">
        ...
        <article className="socials__card">
          ...
          <a href="https://www.linkedin.com/in/rouenemedina/" target="_blank" rel="noopener noreferrer" className="socials__link">
            <h3 className="socials__subtitle">LINKEDIN</h3>
          </a>
        </article>
        <article className="socials__card">
          <img src={github} alt="Rouene's Github" className="socials__img"></img>
          <a href="https://github.com/rouenemedina" target="_blank" rel="noopener noreferrer" className="socials__link">
