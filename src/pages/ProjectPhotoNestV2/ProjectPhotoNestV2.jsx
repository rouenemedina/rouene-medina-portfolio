      ...
      <section className="projectPhotoNestV2__card">
        ...
        <article className="projectPhotoNestV2__details">
          ...
          <p className="projectPhotoNestV2__description">
            Welcome to the second version of PhotoNest, a responsive application
            designed for photographers to showcase their work and connect with
            clients. This version has been entirely rewritten in TypeScript to
